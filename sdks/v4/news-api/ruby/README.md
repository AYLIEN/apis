...
```shell
gem install ./aylien_news_api-4.7.3.gem
```

(for development, run `gem install --dev ./aylien_news_api-4.7.3.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'aylien_news_api', '~> 4.7.3'
